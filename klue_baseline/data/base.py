...
class KlueDataModule(pl.LightningDataModule):
    ...
    def add_specific_args(parser: argparse.ArgumentParser, root_dir: str) -> argparse.ArgumentParser:
        ...
        # parser.add_argument("--data_dir", default='/home/tutor/KLUE-Baseline/data/klue_benchmark/klue-dp-v1.1', type=str, help="The input data dir")
        # /home/tutor/lab17/
        parser.add_argument("--data_dir", default=f'{root_dir}/data/klue_benchmark/klue-ner-v1.1', type=str, help="The input data dir")
        parser.add_argument(
            "--train_file_name",
            default=None,
            type=str,
        ...
        # parser.add_argument("--train_batch_size", default=32, type=int)# default
        # parser.add_argument("--train_batch_size", default=8, type=int)# NER + roberta_large
        parser.add_argument("--train_batch_size", default=16, type=int)# NER + roberta_base
        # parser.add_argument("--eval_batch_size", default=64, type=int)
        parser.add_argument("--eval_batch_size", default=32, type=int)# NER + roberta_base
        return parser
